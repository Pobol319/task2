...
public class RegularExpressions {
    ...
    public static final String SALARY_FIELD_EXPRESSION = "[0-9]+\\.?[0-9]*";
    public static final String RANK_FIELD_EXPRESSION = "\\w*";
    public static final String NORMAL_HOURS_FIELD_EXPRESSION = "[0-9]+\\.?[0-9]*";
    public static final String SCHEDULE_FIELD_EXPRESSION = "\\w*";
    public static final String LEVEL_OF_ENGLISH_FIELD_EXPRESSION = "[B-C]{1}[1-2]{1}";
